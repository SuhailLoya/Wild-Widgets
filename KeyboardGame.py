...
#         self.current_char_countdown = random.randint(2, 5)  # Set initial countdown
...
#                 self.current_char_countdown -= 1

#                 if self.current_char_countdown == 0:
#                     self.current_index += 1
#                     self.current_char_countdown = random.randint(2, 5)
...
#         self.paragraph = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
#         self.current_index = 0
#         self.consecutive_presses_required = 3  # Set the number of consecutive presses required
#         self.current_consecutive_presses = 0
...
#         if event.keysym.isalnum():  # Check if the pressed key is an alphanumeric character
#             if event.char == self.paragraph[self.current_index]:
#                 # Increment the consecutive presses count
#                 self.current_consecutive_presses += 1

#                 if self.current_consecutive_presses == self.consecutive_presses_required:
#                     self.current_index += 1
#                     self.current_consecutive_presses = 0  # Reset consecutive presses
